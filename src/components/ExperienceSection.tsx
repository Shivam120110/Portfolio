    ...
    <section className="py-24 px-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative" ref={ref}>
        ...
        <div className="relative">
          {/* Timeline line */}
          <motion.div
            className="absolute left-8 md:left-1/2 top-0 bottom-0 w-[2px] bg-black/20 rounded-full"
            initial={{ height: 0 }}
          ...
          <div className="space-y-12">
            {experiences.map((exp, index) => (
              ...
              >
                {/* Timeline dot */}
                <motion.div
                  className="absolute left-8 md:left-1/2 w-4 h-4 rounded-full -translate-x-1/2 z-10 clay-card bg-black"
                ...
                <div className={`ml-16 md:ml-0 md:w-[calc(50%-2rem)] ${index % 2 === 0 ? "md:pr-8" : "md:pl-8"}`}>
                  ...
                  >
                    ...
                    <button className="flex items-center gap-1 text-xs text-black hover:text-black/80 transition-colors">
